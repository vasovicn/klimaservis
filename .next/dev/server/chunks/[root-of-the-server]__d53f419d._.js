...
async function POST(request) {
    ...
    if (role === "serviser" && userId !== currentUserId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Možete kreirati termine samo za sebe"
        }, {
            status: 403
        });
    }
    ...
    const knownServices = services.filter((s)=>s !== "ostalo");
    if (knownServices.length > 0 && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateServiceIds"])(knownServices)) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    if (hasOstalo && customDuration && customDuration > 0) {
        ...
        const knownDuration = knownServices.length > 0 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["calculateDuration"])(knownServices) : 0;
        duration = Math.max(knownDuration, customDuration);
    } else if (knownServices.length > 0) {
        duration = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["calculateDuration"])(knownServices);
    } else {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Izaberite uslugu ili unesite trajanje"
        }, {
            status: 400
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d53f419d._.js.map